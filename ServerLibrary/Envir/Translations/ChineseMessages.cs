...
namespace Server.Envir.Translations
{
    ...
    public class ChineseMessages : StringMessages
    {
        ...
        public override string NPCCraftRecipeInvalid { get; set; } = "无法制作，该配方不可用";
        public override string NPCCraftGold { get; set; } = "无法制作，你需要支付{0:#,##0}金币";
        public override string NPCCraftNoRoom { get; set; } = "无法制作，你的背包空间不足";
        public override string NPCCraftIngredients { get; set; } = "无法制作，提供的材料不正确";
        public override string NPCCraftLevel { get; set; } = "无法制作，你需要达到{0}级";
        public override string NPCCraftClass { get; set; } = "无法制作，你的职业无法使用该配方";
        public override string NPCCraftSuccess { get; set; } = "制作成功，你获得了{0} x{1}";
        public override string NPCCraftFailed { get; set; } = "制作失败，材料已被消耗";
