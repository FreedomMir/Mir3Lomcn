...
namespace Server.Envir.Translations
{
    ...
    public class EnglishMessages : StringMessages
    {
        ...
        public override string NPCCraftRecipeInvalid { get; set; } = "Unable to craft, this recipe is not available.";
        public override string NPCCraftGold { get; set; } = "Unable to craft, You need another {0:#,##0} Gold.";
        public override string NPCCraftNoRoom { get; set; } = "Unable to craft, You do not have enough inventory space.";
        public override string NPCCraftIngredients { get; set; } = "Unable to craft, the materials provided are incorrect.";
        public override string NPCCraftLevel { get; set; } = "Unable to craft, You need to be level {0} or higher.";
        public override string NPCCraftClass { get; set; } = "Unable to craft, Your class cannot use this recipe.";
        public override string NPCCraftSuccess { get; set; } = "Crafting successful, You created {0} x{1}.";
        public override string NPCCraftFailed { get; set; } = "Crafting failed, the materials were consumed.";
