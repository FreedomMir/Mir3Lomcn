...
namespace Server.Envir
{
    public abstract class StringMessages
    {
        ...
        public abstract string NPCCraftRecipeInvalid { get; set; }
        public abstract string NPCCraftGold { get; set; }
        public abstract string NPCCraftNoRoom { get; set; }
        public abstract string NPCCraftIngredients { get; set; }
        public abstract string NPCCraftLevel { get; set; }
        public abstract string NPCCraftClass { get; set; }
        public abstract string NPCCraftSuccess { get; set; }
        public abstract string NPCCraftFailed { get; set; }
